      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="bg-[#14151A]/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-gray-800 shadow-2xl space-y-6">
           <div className="flex justify-between items-start">
              ...
              {job.customerPhone && (
                 <a href={`tel:${job.customerPhone}`} className="bg-indigo-500/10 border border-indigo-500/20 p-4 rounded-2xl text-indigo-400 hover:bg-indigo-500/20 transition-all active:scale-95">
           ...
           {job.dispatchNotes && (
              <div className="p-6 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl relative">
                 ...
                 <p className="text-[10px] text-indigo-400 font-black uppercase tracking-widest mb-2 font-bold italic underline underline-offset-4">Dispatch Instructions</p>
